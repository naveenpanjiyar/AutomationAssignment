...
public class Assignment2_Array {
	...
	public static void main(String[] args) {
		...
		supermarket[1][1][0] = "Cola";
		supermarket[1][1][1] = "Orange Juice";
		supermarket[1][1][2] = "Lemonade";
		supermarket[1][1][3] = "Green Tea";
		supermarket[1][1][4] = "Black Coffee";

		supermarket[1][2][0] = "Cola";
		supermarket[1][2][1] = "Orange Juice";
		supermarket[1][2][2] = "Lemonade";
		supermarket[1][2][3] = "Green Tea";
		supermarket[1][2][4] = "Black Coffee";

		supermarket[1][3][0] = "Cola";
		supermarket[1][3][1] = "Orange Juice";
		supermarket[1][3][2] = "Lemonade";
		supermarket[1][3][3] = "Green Tea";
		supermarket[1][3][4] = "Black Coffee";

		System.out.println("Details: " + supermarket[1][3][4]);
